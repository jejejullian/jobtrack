...
function ToastList() {
  ...
  return toasts.map((toastItem) => {
    const typeStyles = {
      ...
      warning: "border-yellow-200 bg-yellow-50 text-yellow-800 dark:border-yellow-900 dark:bg-yellow-950 dark:text-yellow-300",
    ...
    return (
      <Toast key={toastItem.id} toast={toastItem} className={cn(typeStyles[toastItem.type] || typeStyles.info)}>
        <ToastContent>
